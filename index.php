...
$pageTitle = "¿Qué es una SOFOM? Guía Completa México " . date('Y') . " | Tipos ER y ENR, Ejemplos y Directorio";
...
<section class="hero">
  <div class="container">
    <div class="hero-content">
      <div class="hero-text">
        <h1 class="hero-title">
          ¿Qué es una SOFOM en México?<br>
          <span style="font-size: 0.65em; font-weight: 400; opacity: 0.9;">Guía Completa <span class="current-year"></span> + Directorio de <span id="hero-total"><?php echo $sofomesTotal; ?></span> SOFOMes</span>
        </h1>
        <p class="hero-subtitle">
          Una <strong>SOFOM (Sociedad Financiera de Objeto Múltiple)</strong> es una entidad que otorga crédito, arrendamiento y factoraje <strong>sin captar ahorro del público</strong>. Conoce los 2 tipos (ER y ENR), ejemplos reales como Konfío y Kueski, y el directorio completo CONDUSEF.
        </p>
...
<section id="que-es" class="section">
  <div class="container">
    <h2 class="section-title">SOFOM: Definición, Tipos y Características</h2>
...
<section id="directorio" class="section">
  <div class="container">
    <h2 class="section-title">Lista de SOFOMes en México: <span id="directory-title-count">...</span> Registradas en CONDUSEF</h2>
