<?php
$pageTitle = "Catálogo ER: País | SOFOMES.COM";
$pageDescription = "Catálogo de 245 países del mundo para SOFOM ER operaciones internacionales. RIPS F41 CNBV.";
$pageKeywords = "catalogo cnbv, rips f41, pld sofom er, país, operaciones internacionales";
$canonicalUrl = "https://sofomes.com/catalogos-er/pais";
...
$datasetSchema = generateDatasetSchema([
    'name' => 'Catálogo de Países CNBV RIPS F41 (SOFOM ER)',
    'description' => 'Catálogo oficial con 245 países del mundo para SOFOMes Entidad Regulada con operaciones internacionales. EXCLUSIVO RIPS F41.',
    'url' => 'https://sofomes.com/catalogos-er/pais',
    'keywords' => ['RIPS F41', 'CNBV', 'país', 'PLD/FT', 'SOFOM ER', 'operaciones internacionales'],
    'jsonFile' => 'er/pais.json',
    'recordCount' => 245,
    'field' => '',
    'fieldDescription' => 'País de origen del cliente o de la operación'
]);
echo $datasetSchema;
?>
  ...
  <section class="hero" style="padding: 3rem 0;">
    <div class="container">
      ...
      <p class="hero-subtitle" style="text-align: center;"><span id="total-count">245</span> países del mundo</p>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="directory-table">
        <table id="catalog-table" aria-describedby="catalog-description">
          <caption class="sr-only">Catálogo de 245 países del mundo SOFOM ER</caption>
          <thead>
            <tr>
        ...
        <p id="catalog-description" class="sr-only">
          Catálogo oficial de 245 países del mundo. EXCLUSIVO para SOFOM ER con operaciones internacionales. RIPS F41.
        </p>
      </div>

      <?php echo generateDownloadButton('er/pais.json', 245); ?>
    </div>
  </section>
  ...
  <script>
    $(document).ready(function() {
      fetch('../catalogs/json/er/pais.json')
