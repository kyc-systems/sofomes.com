<?php
$pageTitle = "Catálogo ER: Instrumento Monetario | SOFOMES.COM";
$pageDescription = "Catálogo de instrumentos monetarios para SOFOM ER: efectivo, cheque, transferencia. RIPS F41 CNBV campo 9.";
$pageKeywords = "catalogo cnbv, rips f41, pld sofom er, instrumento monetario";
$canonicalUrl = "https://sofomes.com/catalogos-er/instrumento-monetario";
...
$datasetSchema = generateDatasetSchema([
    'name' => 'Catálogo de Instrumentos Monetarios CNBV RIPS F41 (SOFOM ER)',
    'description' => 'Catálogo oficial con 10 instrumentos monetarios para SOFOMes Entidad Regulada: efectivo, cheque, transferencia electrónica. Campo 9 del layout F41.',
    'url' => 'https://sofomes.com/catalogos-er/instrumento-monetario',
    'keywords' => ['RIPS F41', 'CNBV', 'instrumento monetario', 'PLD/FT', 'SOFOM ER', 'efectivo', 'transferencia'],
...
?>
  ...
  <section class="hero" style="padding: 3rem 0;">
    <div class="container">
      ...
      <p class="hero-subtitle" style="text-align: center;"><span id="total-count">10</span> instrumentos según CNBV</p>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      ...
      <div class="directory-table">
        <table id="catalog-table" aria-describedby="catalog-description">
          <caption class="sr-only">
            Catálogo de 10 instrumentos monetarios SOFOM ER
          </caption>
          <thead>
            <tr>
      ...
      <?php echo generateDownloadButton('er/instrumento-monetario.json', 10); ?>
  ...
  <script>
    $(document).ready(function() {
      fetch('../catalogs/json/er/instrumento-monetario.json')
