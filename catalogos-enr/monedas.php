<?php
$pageTitle = "Catálogo ENR: Monedas | SOFOMES.COM";
$pageDescription = "Catálogo de monedas para SOFOM ENR. RIPS F36 CNBV campo 12.";
$pageKeywords = "catalogo cnbv, rips f36, pld sofom enr, monedas";
$canonicalUrl = "https://sofomes.com/catalogos-enr/monedas";
...
$datasetSchema = generateDatasetSchema([
    'name' => 'Catálogo de Monedas CNBV RIPS F36 (SOFOM ENR)',
    'description' => 'Catálogo oficial para SOFOMes Entidad No Regulada. Campo 12 del layout F36.',
    'url' => 'https://sofomes.com/catalogos-enr/monedas',
    'keywords' => ['RIPS F36', 'CNBV', 'monedas', 'PLD/FT', 'SOFOM ENR'],
    'jsonFile' => 'enr/monedas.json',
    'recordCount' => 190,
    'field' => '12',
    'fieldDescription' => 'Monedas'
]);
echo $datasetSchema;
?>
  ...
  <section class="hero" style="padding: 3rem 0;">
    <div class="container">
      ...
      <p class="hero-subtitle" style="text-align: center;"><span id="total-count">190</span> registros</p>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      <div class="alert alert-info">
        ...
        Se reporta en la <strong>columna 12 del layout F36</strong> para SOFOM ENR.
      </div>

      <div class="alert alert-success" style="background: #D1FAE5; border-left: 4px solid #059669;">
        <strong>✅ ENR tiene 192 monedas (ER tiene 123 + Onzas Libertad)</strong>
      </div>
      ...
      <div class="directory-table">
        <table id="catalog-table" aria-describedby="catalog-description">
          <caption class="sr-only">Catálogo de Monedas SOFOM ENR</caption>
          <thead>
            <tr>
        ...
        <p id="catalog-description" class="sr-only">Catálogo de Monedas para SOFOM ENR. Campo 12 del layout RIPS F36.</p>
      </div>

      <?php echo generateDownloadButton('enr/monedas.json', 190); ?>
    </div>
  </section>
  ...
  <script>
    $(document).ready(function() {
      fetch('../catalogs/json/enr/monedas.json')
