<?php
$pageTitle = "Catálogo ENR: Localidades | SOFOMES.COM";
$pageDescription = "Catálogo de localidades para SOFOM ENR. RIPS F36 CNBV campo 6.";
$pageKeywords = "catalogo cnbv, rips f36, pld sofom enr, localidades";
$canonicalUrl = "https://sofomes.com/catalogos-enr/localidades";
...
$datasetSchema = generateDatasetSchema([
    'name' => 'Catálogo de Localidades CNBV RIPS F36 (SOFOM ENR)',
    'description' => 'Catálogo oficial para SOFOMes Entidad No Regulada. Campo 6 del layout F36.',
    'url' => 'https://sofomes.com/catalogos-enr/localidades',
    'keywords' => ['RIPS F36', 'CNBV', 'localidades', 'PLD/FT', 'SOFOM ENR'],
    'jsonFile' => 'enr/localidades.json',
    'recordCount' => 3689,
    'field' => '6',
    'fieldDescription' => 'Localidades'
]);
echo $datasetSchema;
?>
  ...
  <section class="hero" style="padding: 3rem 0;">
    <div class="container">
      ...
      <p class="hero-subtitle" style="text-align: center;"><span id="total-count">3689</span> registros</p>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      <div class="alert alert-info">
        ...
        Se reporta en la <strong>columna 6 del layout F36</strong> para SOFOM ENR.
      </div>
      ...
      <div class="directory-table">
        <table id="catalog-table" aria-describedby="catalog-description">
          <caption class="sr-only">Catálogo de Localidades SOFOM ENR</caption>
          <thead>
            <tr>
        ...
        <p id="catalog-description" class="sr-only">Catálogo de Localidades para SOFOM ENR. Campo 6 del layout RIPS F36.</p>
      </div>

      <?php echo generateDownloadButton('enr/localidades.json', 3689); ?>
    </div>
  </section>
  ...
  <script>
    $(document).ready(function() {
      fetch('../catalogs/json/enr/localidades.json')
