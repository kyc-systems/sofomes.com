...
<section class="section">
  <div class="container">
    ...
    <div class="catalog-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 1.5rem;">
      ...
      <!-- Actividad Económica -->
      <a href="<?= site_url('catalogos-er/actividad-economica') ?>" class="catalog-card">
      ...
      <!-- Monedas -->
      <a href="<?= site_url('catalogos-er/monedas') ?>" class="catalog-card">
        <div class="catalog-icon">💱</div>
        <h3>Monedas</h3>
      ...
      <!-- Países (Exclusivo ER) -->
      <a href="<?= site_url('catalogos-er/pais') ?>" class="catalog-card catalog-exclusive">
        <div class="catalog-icon">🌍</div>
      ...
      <a href="<?= site_url('catalogos-er/tipo-operacion') ?>" class="catalog-card catalog-exclusive">
        <div class="catalog-icon">🔄</div>
      ...
      <a href="<?= site_url('catalogos-er/instrumento-monetario') ?>" class="catalog-card">
        <div class="catalog-icon">💵</div>
      ...
      <!-- Localidades -->
      <a href="<?= site_url('catalogos-er/localidades') ?>" class="catalog-card">
        <div class="catalog-icon">📍</div>
        <h3>Localidades</h3>
      ...
      <!-- Tipo Reporte -->
      <a href="<?= site_url('catalogos-er/tipo-reporte') ?>" class="catalog-card">
        <div class="catalog-icon">📝</div>
        <h3>Tipo Reporte</h3>
