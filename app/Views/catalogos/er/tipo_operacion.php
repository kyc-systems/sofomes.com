  ...
  <section class="hero" style="padding: 3rem 0;">
    <div class="container">
      ...
      <p class="hero-subtitle" style="text-align: center;"><span id="total-count"><?= esc($recordCount) ?></span> tipos de operaciones financieras</p>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      ...
      <div class="alert alert-warning" style="background: #FEF3C7; border-left: 4px solid #F59E0B;">
        ...
        Este catálogo tiene <?= esc($recordCount) ?> tipos porque las ER abarcan operaciones de banca múltiple, valores, seguros, almacenes. Las SOFOM ENR tienen un catálogo separado con 19 tipos específicos de crédito/factoraje.
      </div>
      ...
      <article class="catalog-guide">
        ...
        <div class="catalog-tip">
          <strong>⚡ Tip de cumplimiento:</strong> Si tu SOFOM ER solo realiza operaciones de crédito (08-09), aun así debes usar este catálogo completo de <?= esc($recordCount) ?> tipos. NO uses el catálogo de 19 tipos de SOFOM ENR.
        </div>
      </article>
      ...
      <div class="directory-table">
        <table id="catalog-table" aria-describedby="catalog-description">
          <caption class="sr-only">Catálogo de <?= esc($recordCount) ?> tipos de operación SOFOM ER</caption>
          <thead>
            <tr>
        ...
        <p id="catalog-description" class="sr-only">
          Catálogo de <?= esc($recordCount) ?> tipos de operación financiera para SOFOM ER. Incluye operaciones bancarias, crédito, valores, almacenes. RIPS F41.
        </p>
      </div>
