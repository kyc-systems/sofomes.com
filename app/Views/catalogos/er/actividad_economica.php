  ...
  <section class="hero" style="padding: 3rem 0;">
    <div class="container">
      ...
      <p class="hero-subtitle" style="text-align: center;"><span id="total-count"><?= esc($recordCount) ?></span> actividades según</p>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      ...
      <div class="alert alert-warning" style="background: #FEF3C7; border-left: 4px solid #F59E0B;">
        ...
        Si eres una SOFOM ENR, consulta el <a href="<?= site_url('catalogos-enr/actividad-economica') ?>">catálogo ENR con 1,265 actividades</a>.
      </div>
      ...
      <div class="directory-table">
        <table id="catalog-table" aria-describedby="catalog-description">
          <caption class="sr-only">
            Catálogo completo de <?= esc($recordCount) ?> actividades económicas SOFOM ER
          </caption>
          <thead>
            <tr>
        ...
        <p id="catalog-description" class="sr-only">
          Tabla con <?= esc($recordCount) ?> actividades económicas oficiales según para SOFOM ER.
