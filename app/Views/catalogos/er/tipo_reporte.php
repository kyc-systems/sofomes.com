  ...
  <section class="hero" style="padding: 3rem 0;">
    <div class="container">
      ...
      <p class="hero-subtitle" style="text-align: center;"><span id="total-count"><?= esc($recordCount) ?></span> tipos de reporte según CNBV</p>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="directory-table">
        <table id="catalog-table" aria-describedby="catalog-description">
          <caption class="sr-only">Catálogo de <?= esc($recordCount) ?> tipos de reporte PLD/FT</caption>
          <thead>
            <tr>
