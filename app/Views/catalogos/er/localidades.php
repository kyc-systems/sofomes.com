  ...
  <section class="hero" style="padding: 3rem 0;">
    <div class="container">
      ...
      <p class="hero-subtitle" style="text-align: center;"><span id="total-count"><?= esc($recordCount) ?></span> localidades de México</p>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      ...
      <div class="alert alert-success" style="background: #D1FAE5; border-left: 4px solid #059669;">
        ...
        Las localidades son las mismas en RIPS F41 (ER) y F36 (ENR) - <?= esc($recordCount) ?> localidades INEGI.
      </div>
      ...
      <div class="directory-table">
        <table id="catalog-table" aria-describedby="catalog-description">
          <caption class="sr-only">Catálogo de <?= esc($recordCount) ?> localidades de México</caption>
          <thead>
            <tr>
