    ...
    <div class="container">
      ...
      <div class="grid grid-3" style="gap: 1.5rem;">
        ...
        <div style="background: white; border: 2px solid #10B981; border-radius: 12px; padding: 1.5rem; text-align: center; transition: all 0.3s;">
          ...
          <a href="<?= site_url('catalogos-enr/actividad-economica') ?>" class="btn" style="width: 100%; background: #10B981; color: white;">Ver Catálogo →</a>
        </div>
        ...
        <div style="background: white; border: 2px solid #10B981; border-radius: 12px; padding: 1.5rem; text-align: center; transition: all 0.3s;">
          ...
          <a href="<?= site_url('catalogos-enr/monedas') ?>" class="btn" style="width: 100%; background: #10B981; color: white;">Ver Catálogo →</a>
        </div>
        ...
        <div style="background: white; border: 2px solid #10B981; border-radius: 12px; padding: 1.5rem; text-align: center; transition: all 0.3s;">
          ...
          <a href="<?= site_url('catalogos-enr/localidades') ?>" class="btn" style="width: 100%; background: #10B981; color: white;">Ver Catálogo →</a>
        </div>
        ...
        <div style="background: white; border: 2px solid #10B981; border-radius: 12px; padding: 1.5rem; text-align: center; transition: all 0.3s;">
          ...
          <a href="<?= site_url('catalogos-enr/instrumento-monetario') ?>" class="btn" style="width: 100%; background: #10B981; color: white;">Ver Catálogo →</a>
        </div>
        ...
        <div style="background: white; border: 2px solid #10B981; border-radius: 12px; padding: 1.5rem; text-align: center; transition: all 0.3s;">
          ...
          <a href="<?= site_url('catalogos-enr/tipo-operacion-sofom') ?>" class="btn" style="width: 100%; background: #10B981; color: white;">Ver Catálogo →</a>
        </div>
        ...
        <div style="background: white; border: 2px solid #10B981; border-radius: 12px; padding: 1.5rem; text-align: center; transition: all 0.3s;">
          ...
          <a href="<?= site_url('catalogos-enr/tipo-reporte') ?>" class="btn" style="width: 100%; background: #10B981; color: white;">Ver Catálogo →</a>
        </div>
      </div>

      <div style="text-align: center; margin-top: 2rem;">
        <a href="<?= site_url('catalogos-rips') ?>" class="btn btn-lg" style="background: #047857; color: white; padding: 1rem 2rem; font-size: 1.125rem;">
  ...
  <section class="section" style="background: var(--neutral-50);">
    <div class="container">
      <div style="text-align: center; padding: 3rem 0;">
        ...
        <a href="<?= site_url('layout-reportes-pld') ?>"
      ...
      <div class="grid grid-2" style="margin-top: 2rem;">
        <div style="padding: 1.5rem; background: white; border-radius: var(--border-radius); box-shadow: var(--shadow-md);">
          ...
          <ul class="feature-list">
            <li><a href="<?= site_url('catalogos-enr/actividad-economica') ?>">Actividad Económica del cliente</a></li>
            <li><a href="<?= site_url('catalogos-enr/localidades') ?>">Localidad de la operación</a></li>
            <li><a href="<?= site_url('catalogos-enr/monedas') ?>">Moneda utilizada</a></li>
            <li><a href="<?= site_url('catalogos-enr/instrumento-monetario') ?>">Instrumento monetario</a></li>
          </ul>
        </div>
        ...
        <div style="padding: 1.5rem; background: white; border-radius: var(--border-radius); box-shadow: var(--shadow-md);">
          ...
          <ul class="feature-list">
            <li><a href="<?= site_url('catalogos-enr/tipo-reporte') ?>">Tipo de reporte</a></li>
            <li><a href="<?= site_url('catalogos-enr/actividad-economica') ?>">Actividad económica</a></li>
            <li><a href="<?= site_url('catalogos-enr/localidades') ?>">Localidades involucradas</a></li>
  ...
  <section class="section">
    <div class="container">
      ...
      <div class="alert alert-info" style="margin-top: 3rem; max-width: 900px; margin-left: auto; margin-right: auto;">
        <strong>💡 ¿Más dudas?</strong> Consulta el <a href="<?= site_url('layout-reportes-pld') ?>" style="color: var(--primary-700); text-decoration: underline;">layout completo de 36 campos</a> con validaciones específicas y ejemplos, o revisa los <a href="<?= site_url('catalogos-rips') ?>" style="color: var(--primary-700); text-decoration: underline;">catálogos oficiales CNBV</a> necesarios para llenar correctamente cada campo.
      </div>
    </div>
  </section>
