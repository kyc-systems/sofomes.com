  ...
  <div class="container">
    ...
    <div style="background: linear-gradient(135deg, #FEF3C7 0%, #FDE68A 100%); padding: 2rem; border-radius: 12px; border: 2px solid #F59E0B; margin-bottom: 2rem;">
      ...
      <ol style="line-height: 2; margin: 0; font-size: 1.05rem;">
        <li><strong>Registro CONDUSEF activo:</strong> Consulta el <a href="<?= site_url('lista-sofomes-mexico') ?>">Directorio oficial SOFOMes.com</a> (datos CONDUSEF actualizados)</li>
...
<section class="section" style="background: linear-gradient(135deg, #1F2937 0%, #111827 100%); color: white; padding: 4rem 0;">
  <div class="container" style="text-align: center;">
    ...
    <div class="grid grid-2" style="gap: 1rem; max-width: 600px; margin: 0 auto;">
      <a href="<?= site_url('/') ?>" class="btn btn-primary btn-lg" style="width: 100%;">
        Ver Directorio Completo
      </a>
      <a href="<?= site_url('sofom-er-vs-enr') ?>" class="btn btn-secondary btn-lg" style="width: 100%; background: rgba(255,255,255,0.1); color: white; border: 2px solid rgba(255,255,255,0.3);">
        Comparar ER vs ENR
      </a>
    </div>
  </div>
